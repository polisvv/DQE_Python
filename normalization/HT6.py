...
if __name__ == '__main__':
    ...
    print('----------------')
    text_replace_iz = correct_misspelling(initial_text, 'iz', 'is')
...
def correct_misspelling(text, incorrect_word, correct_word):
    text_replace_iz = text.lower().replace(' ' + incorrect_word + ' ', ' ' + correct_word + ' ')
...
def capitalize_and_append_sent(txt_list):
